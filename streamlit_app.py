...
# Use the user's provided model path
MODEL_PATH = r'C:\Users\Hesham\Desktop\Class_Project\rf_model.pkl'
# Use training data to fit encoders/scaler so we can reproduce notebook feature engineering
TRAIN_CSV = r'C:\Users\Hesham\Desktop\Class_Project\class_marketing_advertising.csv'
